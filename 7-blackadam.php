...
<title>A&H CINEMA - FILM - BLACK ADAM</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="blackadam2.webp" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=7";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='BLACK ADAM')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="7"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer black adam.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Dwayne_Johnson" target="_blank"><img src="Dwayne Johnson.jpg" width="300px" height="300px"></a><br><br>
            Dwayne Johnson
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Aldis_Hodge" target="_blank"><img src="Aldis Hodge.jpg" width="300px" height="300px"></a><br><br>
            Aldis Hodge
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Noah_Centineo" target="_blank"><img src="Noah Centineo.webp" width="300px" height="300px"></a><br><br>
            Noah Centineo
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Sarah_Shahi" target="_blank"><img src="Sarah Shahi.jpg" width="300px" height="300px"></a><br><br>
            Sarah Shahi
        </div>
    </div>
