...
<title>A&H CINEMA - FILM - FAST & FURIOUS 9</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="f&f2.jpg" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=6";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='FAST & FURIOUS 9')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="6"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer f&f9.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Vin_Diesel" target="_blank"><img src="Vin Diesel.jpg" width="300px" height="300px"></a><br><br>
            Vin Diesel
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Michelle_Rodriguez" target="_blank"><img src="Michelle Rodriguez.jpg" width="300px" height="300px"></a><br><br>
            Michelle Rodriguez
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Tyrese_Gibson" target="_blank"><img src="Tyrese Gibson.jpg" width="300px" height="300px"></a><br><br>
            Tyrese Gibson
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Chris_Bridges" target="_blank"><img src="Chris Bridges.webp" width="300px" height="300px"></a><br><br>
