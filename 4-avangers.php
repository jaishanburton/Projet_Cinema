...
<title>A&H CINEMA - FILM - AVANGERS : ENDGAME</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="avangers2.jpg" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=4";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='AVANGERS : ENDGAME')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="4"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer avangers.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Robert_Downey_Jr." target="_blank"><img src="Robert Downey Jr..webp" width="300px" height="300px"></a><br><br>
            Robert Downey Jr.
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Chris_Evans_(actor)" target="_blank"><img src="Chris Evans.jpg" width="300px" height="300px"></a><br><br>
            Chris Evans
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Mark_Ruffalo" target="_blank"><img src="Mark Ruffalo.jpg" width="300px" height="300px"></a><br><br>
            Mark Ruffalo
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Chris_Hemsworth" target="_blank"><img src="Chris Hemsworth.jpg" width="300px" height="300px"></a><br><br>
            Chris Hemsworth
        </div>
    </div>
