...
<title>A&H CINEMA - FILM - SPIDERMAN : NO WAY HOME</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="spiderman2.jpg" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=2";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='SPIDERMAN : NO WAY HOME')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="2"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer spiderman.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Tom_Holland" target="_blank"><img src="Tom Holland.jpg" width="300px" height="300px"></a><br><br>
            Tom Holland
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Tobey_Maguire" target="_blank"><img src="Tobey Maguire.webp" width="300px" height="300px"></a><br><br>
            Tobey Maguire
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Andrew_Garfield" target="_blank"><img src="Andrew Garfield.webp" width="300px" height="300px"></a><br><br>
            Andrew Garfield
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Zendaya" target="_blank"><img src="Zendaya.webp" width="300px" height="300px"></a><br><br>
            Zendaya
        </div>
    </div>
