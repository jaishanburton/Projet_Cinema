...
<title>A&H CINEMA - DELETE A FILM</title>
</head>
...
<body>
	...
	if ($defaut == 0)
	{
		...
		if ($defaut2 == 0)
		{
            $sql = "DELETE FROM `movie` WHERE `movie`.`movieid` = $id";
			$result = $mysqli->query($sql);
			echo("Film successfully delete<br><br>");
			?>
	...
	else
	{
		echo("<br><br>");
		?>
		<button><A href="http://localhost/A&H Cinema - PHP/deletemovie.php">Go Back</A></button>
		<?php	
	}
	?>
