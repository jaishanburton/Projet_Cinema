...
<title>A&H CINEMA - FILM - SONIC 2 : THE HEDGEHOG</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="sonic2.webp" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=8";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='SONIC 2 : THE HEDGEHOG')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="8"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer sonic2.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Ben_Schwartz" target="_blank"><img src="Ben Schwartz.jpg" width="300px" height="300px"></a><br><br>
            Ben Schwartz
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Jim_Carrey" target="_blank"><img src="Jim Carrey.jpg" width="300px" height="300px"></a><br><br>
            Jim Carrey
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/James_Marsden" target="_blank"><img src="James Marsden.png" width="300px" height="300px"></a><br><br>
            James Marsden
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Colleen_O%27Shaughnessey" target="_blank"><img src="Colleen O'Shaughnessey.jpg" width="300px" height="300px"></a><br><br>
