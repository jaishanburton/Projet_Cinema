...
<title>A&H CINEMA - FILM - PIRATE OF THE CARIBBEAN : THE CURSE OF THE BLACK PEARL</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="pirates2.jpg" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=5";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='PIRATE OF THE CARIBBEAN : THE CURSE OF THE BLACK PEARL')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="5"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer pirates.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Johnny_Depp" target="_blank"><img src="Johnny Depp.webp" width="300px" height="300px"></a><br><br>
            Johnny Depp
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Geoffrey_Rush" target="_blank"><img src="Geoffrey Rush.webp" width="300px" height="300px"></a><br><br>
            Geoffrey Rush
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Orlando_Bloom" target="_blank"><img src="Orlando Bloom.jpg" width="300px" height="300px"></a><br><br>
            Orlando Bloom
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Keira_Knightley" target="_blank"><img src="Keira Knightley.jpg" width="300px" height="300px"></a><br><br>
            Keira Knightley
        </div>
    </div>
