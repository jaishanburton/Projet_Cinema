...
<title>A&H CINEMA - FILM - THE BATMAN</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="the batman2.jpg" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=3";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='THE BATMAN')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="3"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer the batman.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Robert_Pattinson" target="_blank"><img src="Robert Pattinson.jpg" width="300px" height="300px"></a><br><br>
            Robert Pattinson
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Zoë_Kravitz" target="_blank"><img src="Zoë Kravitz.webp" width="300px" height="300px"></a><br><br>
            Zoë Kravitz
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Jeffrey_Wright" target="_blank"><img src="Jeffrey Wright.webp" width="300px" height="300px"></a><br><br>
            Jeffrey Wright
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/John_Turturro" target="_blank"><img src="John Turturro.jpg" width="300px" height="300px"></a><br><br>
            John Turturro
        </div>
    </div>
