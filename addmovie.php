...
<body>
    ...
    <form name="MyForm" action="addmovie2.php" method="post">
	<center>
	<form action=""> 
	Movie Id : <input type="text" name="FilmId"> <br><br>
	Movie Name : <input type="text" name="FilmName"> <br><br>
	Movie Synopsis : <br><textarea rows="9" cols="100" name="FilmSynopsis"></textarea> <br><br>
	Movie Duration : <input type="text" name="FilmDuration"> <br><br>
	Movie Actor 1 : <input type="text" name="FilmActor1"> <br><br>
	Movie Actor 2 : <input type="text" name="FilmActor2"> <br><br>
	Movie Actor 3 : <input type="text" name="FilmActor3"> <br><br>
	Movie Actor 4 : <input type="text" name="FilmActor4"> <br><br>
	Movie Actor 5 : <input type="text" name="FilmActor5"> <br><br><br>
