...
<title>A&H CINEMA - FILM - 007 : NO TIME TO DIE</title>
</head>
...
<body>
    ...
    <div class="gridMovieResume">
        <div class="one">
            <img src="0072.jpg" width="404.5px" height="600px">
        </div>
        <div class="two">
			...
			$sql = "SELECT movieid, moviename, moviesynopsis, movieduration, moviecasting1, moviecasting2, moviecasting3, moviecasting4, moviecasting5 FROM movie WHERE movieid=9";
			$result = $mysqli->query($sql);
			$mysqli->close();
			?>
			...
			if ($result->num_rows > 0) {
				// output data of each row
				while($row = $result->fetch_assoc()) {
					if(($row["ticketname"]=='007 : NO TIME TO DIE')&&($row["ticketbuy"]==1))
					{
			...
			<form action="">
			BOOK NOW <select name="FilmTicket"><option value="9"></select>
	...
	<center>
		Trailer<br><br>
		<video autoplay loop muted plays-inline controls width="50%" height="50%"><source src="trailer 007.mp4" type="video/mp4"></video>
	</center>
    ...
    <div class="gridMovieCast">
        <div class="one">
            <a href="https://en.wikipedia.org/wiki/Daniel_Craig" target="_blank"><img src="Daniel Craig.jpg" width="300px" height="300px"></a><br><br>
            Daniel Craig
        </div>		
        <div class="two">
            <a href="https://en.wikipedia.org/wiki/Léa_Seydoux" target="_blank"><img src="Léa Seydoux.jpg" width="300px" height="300px"></a><br><br>
            Léa Seydoux
        </div>		
        <div class="three">
            <a href="https://en.wikipedia.org/wiki/Rami_Malek" target="_blank"><img src="Rami Malek.webp" width="300px" height="300px"></a><br><br>
            Rami Malek
        </div>
        <div class="four">
            <a href="https://en.wikipedia.org/wiki/Lashana_Lynch" target="_blank"><img src="Lashana Lynch.webp" width="300px" height="300px"></a><br><br>
            Lashana Lynch
        </div>
    </div>
